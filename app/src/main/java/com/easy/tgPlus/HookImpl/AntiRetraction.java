		...
		XposedBridge.hookMethod(wantMethod, new XC_MethodReplacement(){
				...
				public void markMessagesDeleted(Object thisMessagesController, long dialogId, ArrayList<Integer> delMsg) {
					...
					while ((boolean)XposedHelpers.callMethod(cursor, "next")) {
						...
						int mid = (int)XposedHelpers.callMethod(cursor, "intValue", new Class<?>[]{int.class}, new Object[]{1});
						dialogId = (long)XposedHelpers.callMethod(cursor, "longValue", new Class<?>[]{int.class}, new Object[]{2});

						XposedHelpers.callMethod(data, "position", new Class<?>[]{int.class}, new Object[]{4});
						int flags = (int)XposedHelpers.callMethod(data, "readInt32", new Class<?>[]{boolean.class}, new Object[]{true});
						flags |= FLAG_DELETED;
						XposedHelpers.callMethod(data, "position", new Class<?>[]{int.class}, new Object[]{4});
		...
		XposedBridge.hookMethod(wantMethod, new XC_MethodHook(){
				...
				protected void afterHookedMethod(XC_MethodHook.MethodHookParam param) throws Throwable {
					...
					if ((flags & FLAG_DELETED) != 0) {
						...
						int timeTextWidth = (int) XposedHelpers.getObjectField(thisMsgCell, "timeTextWidth");
						int timeWidth = (int) XposedHelpers.getObjectField(thisMsgCell, "timeWidth");
